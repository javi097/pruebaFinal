...
class Interceptor extends \Hiberus\Garcia\Model\Examen implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIdExam');
        if (!$pluginInfo) {
            return parent::getIdExam();
        } else {
            return $this->___callPlugins('getIdExam', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setIdExam');
        if (!$pluginInfo) {
            return parent::setIdExam($idExam);
        } else {
            return $this->___callPlugins('setIdExam', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setMark');
        if (!$pluginInfo) {
            return parent::setMark($mark);
        } else {
            return $this->___callPlugins('setMark', func_get_args(), $pluginInfo);
        }
    }
