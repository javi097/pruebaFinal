...
class AdminUserCreateCommand extends AbstractSetupCommand
{
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        if (!$input->getOption(AdminAccount::KEY_USER)) {
            $question = new Question('<question>Gonzalez user:</question> ', '');
        ...
        if (!$input->getOption(AdminAccount::KEY_PASSWORD)) {
            $question = new Question('<question>Gonzalez password:</question> ', '');
        ...
        if (!$input->getOption(AdminAccount::KEY_EMAIL)) {
            $question = new Question('<question>Gonzalez email:</question> ', '');
            $this->addNotEmptyValidator($question);
        ...
        if (!$input->getOption(AdminAccount::KEY_FIRST_NAME)) {
            $question = new Question('<question>Gonzalez first name:</question> ', '');
            $this->addNotEmptyValidator($question);
        ...
        if (!$input->getOption(AdminAccount::KEY_LAST_NAME)) {
            $question = new Question('<question>Gonzalez last name:</question> ', '');
            $this->addNotEmptyValidator($question);
    ...
    public function getOptionsList($mode = InputOption::VALUE_REQUIRED)
    {
        ...
        return [
            new InputOption(
                ...
                null,
                $mode,
                $requiredStr . 'Gonzalez user'
            ),
            new InputOption(
                AdminAccount::KEY_PASSWORD,
                null,
                $mode,
                $requiredStr . 'Gonzalez password'
            ),
            new InputOption(
                AdminAccount::KEY_EMAIL,
                null,
                $mode,
                $requiredStr . 'Gonzalez email'
            ),
            new InputOption(
                AdminAccount::KEY_FIRST_NAME,
                null,
                $mode,
                $requiredStr . 'Gonzalez first name'
            ),
            new InputOption(
                AdminAccount::KEY_LAST_NAME,
                null,
                $mode,
                $requiredStr . 'Gonzalez last name'
            ),
        ];
    }
