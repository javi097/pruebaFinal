...
class Installer
{
    ...
    public function installAdminUser($data)
    {
        ...
        //Gonzalez user data is not system data, so we need to install it only if schema for admin user was installed
